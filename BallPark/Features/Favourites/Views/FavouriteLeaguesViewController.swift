...
class FavouriteLeaguesViewController: UITableViewController, AnyStoryboardView, WithLoaderView, WithEmptyView, WithErrorView {
    ...
    func inject(_ container: Container) {
        ...
        viewModel = container.require((any AnyFavouriteLeaguesViewModelFactory).self).create()
    }
